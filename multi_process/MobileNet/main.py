...
if __name__ == '__main__':
    ...
    pi_svm_layer58_layer61_p = Pisvm(pi_svm_path[0], d_m_check_queue, '58/61', 0, d_m_layer58_queue, d_m_layer61_queue, mutex)
    pi_svm_layer61_layer64_p = Pisvm(pi_svm_path[0], d_m_check_queue, '61/64', 1, d_m_layer61_queue, d_m_layer64_queue, mutex)
    pi_svm_layer64_layer67_p = Pisvm(pi_svm_path[0], d_m_check_queue, '64/67', 2, d_m_layer64_queue, d_m_layer67_queue, mutex)
    pi_svm_layer67_layer70_p = Pisvm(pi_svm_path[0], d_m_check_queue, '67/70', 3, d_m_layer67_queue, d_m_layer70_queue, mutex)
    pi_svm_layer70_layer73_p = Pisvm(pi_svm_path[0], d_m_check_queue, '70/73', 4, d_m_layer70_queue, d_m_layer73_queue, mutex)
    pi_svm_layer73_layer76_p = Pisvm(pi_svm_path[0], d_m_check_queue, '73/76', 5, d_m_layer73_queue, d_m_layer76_queue, mutex)
    pi_svm_layer76_layer79_p = Pisvm(pi_svm_path[0], d_m_check_queue, '76/79', 6, d_m_layer76_queue, d_m_layer79_queue, mutex)
    pi_svm_layer79_layer80_p = Pisvm(pi_svm_path[0], d_m_check_queue, '79/80', 7, d_m_layer79_queue, d_m_layer80_queue, mutex)
    ...
    pi_svm_layer58_layer61_p.start()
    pi_svm_layer61_layer64_p.start()
    pi_svm_layer64_layer67_p.start()
    pi_svm_layer67_layer70_p.start()
    pi_svm_layer70_layer73_p.start()
    pi_svm_layer73_layer76_p.start()
    pi_svm_layer76_layer79_p.start()
    pi_svm_layer79_layer80_p.start()
    ...
    pi_svm_layer58_layer61_pid = pi_svm_layer58_layer61_p.pid
    pi_svm_layer61_layer64_pid = pi_svm_layer61_layer64_p.pid
    pi_svm_layer64_layer67_pid = pi_svm_layer64_layer67_p.pid
    pi_svm_layer67_layer70_pid = pi_svm_layer67_layer70_p.pid
    pi_svm_layer70_layer73_pid = pi_svm_layer70_layer73_p.pid
    pi_svm_layer73_layer76_pid = pi_svm_layer73_layer76_p.pid
    pi_svm_layer76_layer79_pid = pi_svm_layer76_layer79_p.pid
    pi_svm_layer79_layer80_pid = pi_svm_layer79_layer80_p.pid

    derived_model_layer58_p = DerivedModel('DM layer58', 0, d_m_check_queue, hidden_queue_2, derived_model_layer58, d_m_layer58_queue, mutex, pi_svm_layer58_layer61_pid, hidden_2_mutex, dm_path[0])
    derived_model_layer61_p = DerivedModel('DM layer61', 1, d_m_check_queue, hidden_queue_2, derived_model_layer61, d_m_layer61_queue, mutex, pi_svm_layer58_layer61_pid, hidden_2_mutex, dm_path[0])
    derived_model_layer64_p = DerivedModel('DM layer64', 2, d_m_check_queue, hidden_queue_2, derived_model_layer64, d_m_layer64_queue, mutex, pi_svm_layer61_layer64_pid, hidden_2_mutex, dm_path[0])
    derived_model_layer67_p = DerivedModel('DM layer67', 3, d_m_check_queue, hidden_queue_2, derived_model_layer67, d_m_layer67_queue, mutex, pi_svm_layer64_layer67_pid, hidden_2_mutex, dm_path[0])
    derived_model_layer70_p = DerivedModel('DM layer70', 4, d_m_check_queue, hidden_queue_2, derived_model_layer70, d_m_layer70_queue, mutex, pi_svm_layer67_layer70_pid, hidden_2_mutex, dm_path[2])
    derived_model_layer73_p = DerivedModel('DM layer73', 5, d_m_check_queue, hidden_queue_2, derived_model_layer73, d_m_layer73_queue, mutex, pi_svm_layer70_layer73_pid, hidden_2_mutex, dm_path[1])
    derived_model_layer76_p = DerivedModel('DM layer76', 6, d_m_check_queue, hidden_queue_2, derived_model_layer76, d_m_layer76_queue, mutex, pi_svm_layer73_layer76_pid, hidden_2_mutex, dm_path[3])
    derived_model_layer79_p = DerivedModel('DM layer79', 7, d_m_check_queue, hidden_queue_2, derived_model_layer79, d_m_layer79_queue, mutex, pi_svm_layer76_layer79_pid, hidden_2_mutex, dm_path[3])
    derived_model_layer80_p = DerivedModel('DM layer80', 8, d_m_check_queue, hidden_queue_2, derived_model_layer80, d_m_layer80_queue, mutex, pi_svm_layer79_layer80_pid, hidden_2_mutex, dm_path[4])
    ...
    print(f"MobileNet inference time : {end_target - start:.3f} sec ")
    ...
    pi_svm_layer58_layer61_p.join()
    pi_svm_layer61_layer64_p.join()
    pi_svm_layer64_layer67_p.join()
    pi_svm_layer67_layer70_p.join()
    pi_svm_layer70_layer73_p.join()
    pi_svm_layer73_layer76_p.join()
    pi_svm_layer76_layer79_p.join()
    pi_svm_layer79_layer80_p.join()
    ...
    end_all = time.time()
    print(f"MobileNet total time : {end_all - start:.3f} sec ")
