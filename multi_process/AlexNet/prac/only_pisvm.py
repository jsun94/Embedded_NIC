...
class AlexNet(nn.Module):
    ...
    def forward(self, x: torch.Tensor, hidden_queue, hidden_queue_2, derived_model_layer2_pid, derived_model_layer3_pid, derived_model_layer5_pid, derived_model_layer6_pid, derived_model_layer8_pid, derived_model_layer10_pid, derived_model_layer12_pid, derived_model_layer13_pid, derived_model_layer14_pid, derived_model_layer17_pid, derived_model_layer20_pid, hidden_1_mutex, hidden_2_mutex) -> torch.Tensor:
        x = self.layer1(x)
...
if __name__ == '__main__':
    ...
    start.record()
    result = model(test_input, hidden_queue, hidden_queue_2, derived_model_layer2_pid, derived_model_layer3_pid, derived_model_layer5_pid, derived_model_layer6_pid, derived_model_layer8_pid, derived_model_layer10_pid, derived_model_layer12_pid, derived_model_layer13_pid, derived_model_layer14_pid, derived_model_layer17_pid, derived_model_layer20_pid, hidden_1_mutex, hidden_2_mutex)
    end.record()
