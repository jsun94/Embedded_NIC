...
class AlexNet(nn.Module):
    ...
    def forward(self, x: torch.Tensor, hidden_queue, hidden_queue_2, vi_svm_layer13_pid, derived_model_layer13_pid, vi_svm_layer14_pid, derived_model_layer14_pid, vi_svm_layer17_pid, derived_model_layer17_pid, vi_svm_layer20_pid, derived_model_layer20_pid, hidden_1_mutex, hidden_2_mutex) -> torch.Tensor:
        x = self.layer1(x)
...
if __name__ == '__main__':
    ...
    # vi_svm_path = ['/home/nvidia/joo/models/AlexNet/VISVM/max_layer13_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/max_layer14_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/max_layer17_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/max_layer20_visvm.bin']
    # # vi_svm_path = ['/home/nvidia/joo/models/AlexNet/VISVM/layer13_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/layer14_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/layer17_visvm.bin', '/home/nvidia/joo/models/AlexNet/VISVM/layer20_visvm.bin']
    ...
    # pi_svm_path = ['/home/nvidia/joo/models/PI_SVM/ReLU_13_ReLU_15_PI_SVM_model.bin']
    vi_svm_path = ['/home/nvidia/joo/models/AlexNet/Alternative/VISVM/layer13_visvm.bin', '/home/nvidia/joo/models/AlexNet/Alternative/VISVM/layer14_visvm.bin', '/home/nvidia/joo/models/AlexNet/Alternative/VISVM/layer17_visvm.bin', '/home/nvidia/joo/models/AlexNet/Alternative/VISVM/layer20_visvm.bin']
    dm_path = ['/home/nvidia/joo/models/AlexNet/D_M/alex_dict_16384', '/home/nvidia/joo/models/AlexNet/D_M/alex_dict_4096', '/home/nvidia/joo/models/AlexNet/D_M/alex_dict_12288', '/home/nvidia/joo/models/AlexNet/D_M/alex_dict_3072', '/home/nvidia/joo/models/AlexNet/D_M/alex_dict_6144', '/home/nvidia/joo/models/AlexNet/D_M/alex_dict_1024']
    pi_svm_path = ['/home/nvidia/joo/models/SqueezeNet/Alternative/PISVM/layer65_layer70_pisvm.bin']
    ...
    vi_svm_layer14_p = Visvm(hidden_queue, 'layer14', vi_svm_path[1], hidden_1_mutex, 1024)
    vi_svm_layer17_p = Visvm(hidden_queue, 'layer17', vi_svm_path[2], hidden_1_mutex, 4096)
    vi_svm_layer20_p = Visvm(hidden_queue, 'layer20', vi_svm_path[3], hidden_1_mutex, 4096)
    ...
    derived_model_layer13_p = DerivedModel('DM layer13', 0, d_m_check_queue, hidden_queue_2, derived_model_layer13, d_m_layer13_queue, d_m_layer13_queue, mutex, hidden_2_mutex, dm_path[5], pi_svm_path[0], 1024)
    derived_model_layer14_p = DerivedModel('DM layer14', 1, d_m_check_queue, hidden_queue_2, derived_model_layer14, d_m_layer13_queue, d_m_layer14_queue, mutex, hidden_2_mutex, dm_path[5], pi_svm_path[0], 1024)
    derived_model_layer17_p = DerivedModel('DM layer17', 2, d_m_check_queue, hidden_queue_2, derived_model_layer17, d_m_layer14_queue, d_m_layer17_queue, mutex, hidden_2_mutex, dm_path[1], pi_svm_path[0], 4096)
    derived_model_layer20_p = DerivedModel('DM layer20', 3, d_m_check_queue, hidden_queue_2, derived_model_layer20, d_m_layer17_queue, d_m_layer20_queue, mutex, hidden_2_mutex, dm_path[1], pi_svm_path[0], 4096)
    ...
    start.record()
    result = model(test_input, hidden_queue, hidden_queue_2, vi_svm_layer13_pid, derived_model_layer13_pid, vi_svm_layer14_pid, derived_model_layer14_pid, vi_svm_layer17_pid, derived_model_layer17_pid, vi_svm_layer20_pid, derived_model_layer20_pid, hidden_1_mutex, hidden_2_mutex)
    end.record()
