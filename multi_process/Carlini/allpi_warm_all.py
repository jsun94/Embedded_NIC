...
class CarliniModel(nn.Module):
    ...
    def forward(self, x, hidden_queue, hidden_queue_2, derived_model_relu_2_pid, derived_model_relu_4_pid, derived_model_maxpool2d_5_pid, derived_model_relu_7_pid, derived_model_relu_9_pid, vi_svm_maxpool2d_10_pid, derived_model_maxpool2d_10_pid, vi_svm_flatten_11_pid, derived_model_flatten_11_pid, vi_svm_relu_13_pid, derived_model_relu_13_pid, vi_svm_relu_15_pid, derived_model_relu_15_pid, hidden_1_mutex, hidden_2_mutex):
        out = self.layer1(x)
...
if __name__ == '__main__':
    ...
    dm_path = ['/home/nvidia/joo/models/Carlini/D_M/MP/layer2_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer4_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer5_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer7_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer9_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer10_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer11_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer13_derived_model_dict.pt', '/home/nvidia/joo/models/Carlini/D_M/MP/layer15_derived_model_dict.pt']
    pi_svm_path = ['/home/nvidia/joo/models/Carlini/PISVM/layer2_layer4_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer4_layer5_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer5_layer7_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer7_layer9_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer9_layer10_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer10_layer11_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer11_layer13_pisvm.bin', '/home/nvidia/joo/models/Carlini/PISVM/layer13_layer15_pisvm.bin']
    ...
    derived_model_relu_9 = derived_model.Derived_Model9()
    derived_model_maxpool2d_10 = derived_model.Derived_Model10()
    derived_model_flatten_11 = derived_model.Derived_Model11()
    derived_model_relu_13 = derived_model.Derived_Model13()
    derived_model_relu_15 = derived_model.Derived_Model15()
    ...
    derived_model_relu_9_p = DerivedModel('DM RELU9', 4, d_m_check_queue, hidden_queue_2, derived_model_relu_9, d_m_relu_7_queue, d_m_relu_9_queue, mutex, hidden_2_mutex, dm_path[4], pi_svm_path[3], 12800)
    derived_model_maxpool2d_10_p = DerivedModel('DM MAX10', 5, d_m_check_queue, hidden_queue_2, derived_model_maxpool2d_10, d_m_relu_9_queue, d_m_maxpool2d_10_queue, mutex, hidden_2_mutex, dm_path[5], pi_svm_path[4], 3200)
    derived_model_flatten_11_p = DerivedModel('DM FLAT11', 6, d_m_check_queue, hidden_queue_2, derived_model_flatten_11, d_m_maxpool2d_10_queue, d_m_flatten_11_queue, mutex, hidden_2_mutex, dm_path[6], pi_svm_path[5], 3200)
    derived_model_relu_13_p = DerivedModel('DM RELU13', 7, d_m_check_queue, hidden_queue_2, derived_model_relu_13, d_m_flatten_11_queue, d_m_relu_13_queue, mutex, hidden_2_mutex, dm_path[7], pi_svm_path[6], 256)
    derived_model_relu_15_p = DerivedModel('DM RELU15', 8, d_m_check_queue, hidden_queue_2, derived_model_relu_15, d_m_relu_13_queue, d_m_relu_15_queue, mutex, hidden_2_mutex, dm_path[8], pi_svm_path[7], 256)
    ...
    model(test_data,hidden_queue, hidden_queue_2, derived_model_relu_2_pid, derived_model_relu_4_pid, derived_model_maxpool2d_5_pid, derived_model_relu_7_pid, derived_model_relu_9_pid, vi_svm_maxpool2d_10_pid, derived_model_maxpool2d_10_pid, vi_svm_flatten_11_pid, derived_model_flatten_11_pid, vi_svm_relu_13_pid, derived_model_relu_13_pid, vi_svm_relu_15_pid, derived_model_relu_15_pid, hidden_1_mutex, hidden_2_mutex)
    end.record()
