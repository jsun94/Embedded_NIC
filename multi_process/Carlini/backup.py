...
################ MULTI PROCESS CARLINI SIGNAL.PAUSE() WHILE INFERNECE###################
...
class CarliniModel(nn.Module):
    ...
    def forward_handler(self, signum, frame):
        print('get signal')

    def forward(self, x, hidden_queue, hidden_queue_2, vi_svm_relu_2_pid, derived_model_relu_2_pid, vi_svm_relu_4_pid, derived_model_relu_4_pid, vi_svm_maxpool2d_5_pid, derived_model_maxpool2d_5_pid, vi_svm_relu_7_pid, derived_model_relu_7_pid, vi_svm_relu_9_pid, derived_model_relu_9_pid, vi_svm_maxpool2d_10_pid, derived_model_maxpool2d_10_pid, vi_svm_flatten_11_pid, derived_model_flatten_11_pid, vi_svm_relu_13_pid, derived_model_relu_13_pid, vi_svm_relu_15_pid, derived_model_relu_15_pid):	# each out size of byte : 64
    # def forward(self, x, hidden_queue, hidden_queue_2, vi_svm_relu_2_pid, derived_model_relu_2_pid, vi_svm_relu_4_pid, derived_model_relu_4_pid, derived_model_maxpool2d_5_pid, dm_mutex):	# each out size of byte : 64
        signal.signal(signal.SIGUSR2, self.forward_handler)
        out = self.layer1(x)
...
if __name__ == '__main__':	
    ...
    vi_svm_relu_2_p = Visvm(hidden_queue, 'RELU2', vi_svm_path[0])
    vi_svm_relu_4_p = Visvm(hidden_queue, 'RELU4', vi_svm_path[1])
    vi_svm_maxpool2d_5_p = Visvm(hidden_queue, 'MAX5', vi_svm_path[2])
    vi_svm_relu_7_p = Visvm(hidden_queue, 'RELU7', vi_svm_path[3])
    vi_svm_relu_9_p = Visvm(hidden_queue, 'RELU9', vi_svm_path[4])
    vi_svm_maxpool2d_10_p = Visvm(hidden_queue, 'MAX10', vi_svm_path[5])
    vi_svm_flatten_11_p = Visvm(hidden_queue, 'FLAT11', vi_svm_path[6])
    vi_svm_relu_13_p = Visvm(hidden_queue, 'RELU13', vi_svm_path[7])
    vi_svm_relu_15_p = Visvm(hidden_queue, 'RELU15', vi_svm_path[8])
    ...
    derived_model_relu_2_p = DerivedModel('DM RELU2', 0, d_m_check_queue, hidden_queue_2, derived_model_relu_2, d_m_relu_2_queue, mutex, pi_svm_relu_2_relu_4_pid)
    derived_model_relu_4_p = DerivedModel('DM RELU4', 1, d_m_check_queue, hidden_queue_2, derived_model_relu_4, d_m_relu_4_queue, mutex, pi_svm_relu_2_relu_4_pid)
    derived_model_maxpool2d_5_p = DerivedModel('DM MAX5', 2, d_m_check_queue, hidden_queue_2, derived_model_maxpool2d_5, d_m_maxpool2d_5_queue, mutex, pi_svm_relu_4_maxpool2d_5_pid)
    derived_model_relu_7_p = DerivedModel('DM RELU7', 3, d_m_check_queue, hidden_queue_2, derived_model_relu_7, d_m_relu_7_queue, mutex, pi_svm_maxpool2d_5_relu_7_pid)
    derived_model_relu_9_p = DerivedModel('DM RELU9', 4, d_m_check_queue, hidden_queue_2, derived_model_relu_9, d_m_relu_9_queue, mutex, pi_svm_relu_7_relu_9_pid)
    derived_model_maxpool2d_10_p = DerivedModel('DM MAX10', 5, d_m_check_queue, hidden_queue_2, derived_model_maxpool2d_10, d_m_maxpool2d_10_queue, mutex, pi_svm_relu_9_maxpool2d_10_pid)
    derived_model_flatten_11_p = DerivedModel('DM FLAT11', 6, d_m_check_queue, hidden_queue_2, derived_model_flatten_11, d_m_flatten_11_queue, mutex, pi_svm_maxpool2d_10_flatten_11_pid)
    derived_model_relu_13_p = DerivedModel('DM RELU13', 7, d_m_check_queue, hidden_queue_2, derived_model_relu_13, d_m_relu_13_queue, mutex, pi_svm_flatten_11_relu_13_pid)
    derived_model_relu_15_p = DerivedModel('DM RELU15', 8, d_m_check_queue, hidden_queue_2, derived_model_relu_15, d_m_relu_15_queue, mutex, pi_svm_relu_13_relu_15_pid)
    ...
    model(test_data,hidden_queue, hidden_queue_2, vi_svm_relu_2_pid, derived_model_relu_2_pid, vi_svm_relu_4_pid, derived_model_relu_4_pid, vi_svm_maxpool2d_5_pid, derived_model_maxpool2d_5_pid, vi_svm_relu_7_pid, derived_model_relu_7_pid, vi_svm_relu_9_pid, derived_model_relu_9_pid, vi_svm_maxpool2d_10_pid, derived_model_maxpool2d_10_pid, vi_svm_flatten_11_pid, derived_model_flatten_11_pid, vi_svm_relu_13_pid, derived_model_relu_13_pid, vi_svm_relu_15_pid, derived_model_relu_15_pid)
	...
	################ MULTI PROCESS CARLINI NO SIGNAL.PAUSE() WHILE INFERNECE###################
...
if __name__ == '__main__':	
    ...
    vi_svm_relu_4_p = Visvm(hidden_queue_relu_4, 'RELU4', vi_svm_path[1])
