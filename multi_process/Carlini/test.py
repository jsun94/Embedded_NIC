...
class DerivedModel(Process):		
    ...
    def run(self):
        ...
        self.derived_model.load_state_dict(torch.load(self.dm_path, map_location ='cuda'))
...
if __name__ == '__main__':	
    ...
    # hidden alyer output queue for target->visvm
    hidden_queue = Queue()
    ...
    pi_svm_path = ['/home/nvidia/joo/models/PI_SVM/ReLU_2_ReLU_4_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/ReLU_4_MaxPool2d_5_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/MaxPool2d_5_ReLU_7_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/ReLU_7_ReLU_9_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/ReLU_9_MaxPool2d_10_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/MaxPool2d_10_Flatten_11_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/Flatten_11_ReLU_13_PI_SVM_model.bin', '/home/nvidia/joo/models/PI_SVM/ReLU_13_ReLU_15_PI_SVM_model.bin']
    ...
    vi_svm_maxpool2d_5_p = Visvm(hidden_queue, 'MAX5', vi_svm_path[2], hidden_1_mutex)
    vi_svm_relu_7_p = Visvm(hidden_queue, 'RELU7', vi_svm_path[3], hidden_1_mutex)
    vi_svm_relu_9_p = Visvm(hidden_queue, 'RELU9', vi_svm_path[4], hidden_1_mutex)
    vi_svm_maxpool2d_10_p = Visvm(hidden_queue, 'MAX10', vi_svm_path[5], hidden_1_mutex)
    vi_svm_flatten_11_p = Visvm(hidden_queue, 'FLAT11', vi_svm_path[6], hidden_1_mutex)
    vi_svm_relu_13_p = Visvm(hidden_queue, 'RELU13', vi_svm_path[7], hidden_1_mutex)
    vi_svm_relu_15_p = Visvm(hidden_queue, 'RELU15', vi_svm_path[8], hidden_1_mutex)

    pi_svm_relu_2_relu_4_p = Pisvm(pi_svm_path[0], d_m_check_queue, 'RE2RE4', 0, d_m_relu_2_queue, d_m_relu_4_queue, mutex)
    pi_svm_relu_4_maxpool2d_5_p = Pisvm(pi_svm_path[1], d_m_check_queue, 'RE4MX5', 1, d_m_relu_4_queue, d_m_maxpool2d_5_queue, mutex)
    pi_svm_maxpool2d_5_relu_7_p = Pisvm(pi_svm_path[2], d_m_check_queue, 'MX5RE7', 2, d_m_maxpool2d_5_queue, d_m_relu_7_queue, mutex)
    pi_svm_relu_7_relu_9_p = Pisvm(pi_svm_path[3], d_m_check_queue, 'RE7RE9', 3, d_m_relu_7_queue, d_m_relu_9_queue, mutex)
    pi_svm_relu_9_maxpool2d_10_p = Pisvm(pi_svm_path[4], d_m_check_queue, 'RE9MX10', 4, d_m_relu_9_queue, d_m_maxpool2d_10_queue, mutex)
    pi_svm_maxpool2d_10_flatten_11_p = Pisvm(pi_svm_path[5], d_m_check_queue, 'MX10FL11', 5, d_m_maxpool2d_10_queue, d_m_flatten_11_queue, mutex)
    pi_svm_flatten_11_relu_13_p = Pisvm(pi_svm_path[6], d_m_check_queue, 'FL11RE13', 6, d_m_flatten_11_queue, d_m_relu_13_queue, mutex)
    pi_svm_relu_13_relu_15_p = Pisvm(pi_svm_path[7], d_m_check_queue, 'RE13RE15', 7, d_m_relu_13_queue, d_m_relu_15_queue, mutex)
    ...
    derived_model_relu_2_p = DerivedModel('DM RELU2', 0, d_m_check_queue, hidden_queue_2, derived_model_relu_2, d_m_relu_2_queue, mutex, pi_svm_relu_2_relu_4_pid, hidden_2_mutex, dm_path[0])
    derived_model_relu_4_p = DerivedModel('DM RELU4', 1, d_m_check_queue, hidden_queue_2, derived_model_relu_4, d_m_relu_4_queue, mutex, pi_svm_relu_2_relu_4_pid, hidden_2_mutex, dm_path[1])
    derived_model_maxpool2d_5_p = DerivedModel('DM MAX5', 2, d_m_check_queue, hidden_queue_2, derived_model_maxpool2d_5, d_m_maxpool2d_5_queue, mutex, pi_svm_relu_4_maxpool2d_5_pid, hidden_2_mutex, dm_path[2])
    derived_model_relu_7_p = DerivedModel('DM RELU7', 3, d_m_check_queue, hidden_queue_2, derived_model_relu_7, d_m_relu_7_queue, mutex, pi_svm_maxpool2d_5_relu_7_pid, hidden_2_mutex, dm_path[3])
    derived_model_relu_9_p = DerivedModel('DM RELU9', 4, d_m_check_queue, hidden_queue_2, derived_model_relu_9, d_m_relu_9_queue, mutex, pi_svm_relu_7_relu_9_pid, hidden_2_mutex, dm_path[4])
    derived_model_maxpool2d_10_p = DerivedModel('DM MAX10', 5, d_m_check_queue, hidden_queue_2, derived_model_maxpool2d_10, d_m_maxpool2d_10_queue, mutex, pi_svm_relu_9_maxpool2d_10_pid, hidden_2_mutex, dm_path[5])
    derived_model_flatten_11_p = DerivedModel('DM FLAT11', 6, d_m_check_queue, hidden_queue_2, derived_model_flatten_11, d_m_flatten_11_queue, mutex, pi_svm_maxpool2d_10_flatten_11_pid, hidden_2_mutex, dm_path[6])
    derived_model_relu_13_p = DerivedModel('DM RELU13', 7, d_m_check_queue, hidden_queue_2, derived_model_relu_13, d_m_relu_13_queue, mutex, pi_svm_flatten_11_relu_13_pid, hidden_2_mutex, dm_path[7])
    derived_model_relu_15_p = DerivedModel('DM RELU15', 8, d_m_check_queue, hidden_queue_2, derived_model_relu_15, d_m_relu_15_queue, mutex, pi_svm_relu_13_relu_15_pid, hidden_2_mutex, dm_path[8])
	...
	# time.sleep(4)
	# print('from main checker : ', d_m_check_queue.get())
