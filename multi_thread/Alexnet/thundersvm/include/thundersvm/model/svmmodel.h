...
public:
    ...
    //skycs gpu = 0 cpu = 1
    virtual vector<float_type> predict_with_core(const DataSet::node2d &instances, int batch_size, int core_type, int n_core);
    ...
    void predict_dec_values_with_core(const DataSet::node2d &instances, SyncArray<float_type> &dec_values,
